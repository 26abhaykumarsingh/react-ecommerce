...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    setfilter(newFilter); //square bracket on section.id because its a variable behaving as a key
  };
...
function Pagination({ page, setPage, handlePage, totalItems }) {
  ...
  return (
    <div className="cursor-pointer flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            ...
            {/* we dont care whats inside this array we only want to create a
